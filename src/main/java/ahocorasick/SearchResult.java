...
/**
 * <p>Holds the result of the search so far. Includes the outputs where the
 * search finished as well as the last index of the matching.</p>
 *
 * <p>(Internally, it also holds enough state to continue a running search,
 * though this is not exposed for public use.)</p>
 */
